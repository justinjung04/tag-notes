...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5);
	var ReactBootstrap = __webpack_require__(6);
	var TagSearchMain = __webpack_require__(13);
	var TagButton = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Accordion = _interopRequire(__webpack_require__(18));

	var Affix = _interopRequire(__webpack_require__(19));

	var AffixMixin = _interopRequire(__webpack_require__(20));

	var Alert = _interopRequire(__webpack_require__(21));

	var BootstrapMixin = _interopRequire(__webpack_require__(22));

	var Badge = _interopRequire(__webpack_require__(23));

	var Button = _interopRequire(__webpack_require__(24));

	var ButtonGroup = _interopRequire(__webpack_require__(25));

	var ButtonToolbar = _interopRequire(__webpack_require__(26));

	var CollapsableNav = _interopRequire(__webpack_require__(27));

	var Carousel = _interopRequire(__webpack_require__(28));

	var CarouselItem = _interopRequire(__webpack_require__(29));

	var Col = _interopRequire(__webpack_require__(30));

	var CollapsableMixin = _interopRequire(__webpack_require__(31));

	var DropdownButton = _interopRequire(__webpack_require__(32));

	var DropdownMenu = _interopRequire(__webpack_require__(33));

	var DropdownStateMixin = _interopRequire(__webpack_require__(34));

	var FadeMixin = _interopRequire(__webpack_require__(35));

	var Glyphicon = _interopRequire(__webpack_require__(36));

	var Grid = _interopRequire(__webpack_require__(37));

	var Input = _interopRequire(__webpack_require__(38));

	var Interpolate = _interopRequire(__webpack_require__(39));

	var Jumbotron = _interopRequire(__webpack_require__(40));

	var Label = _interopRequire(__webpack_require__(41));

	var ListGroup = _interopRequire(__webpack_require__(42));

	var ListGroupItem = _interopRequire(__webpack_require__(43));

	var MenuItem = _interopRequire(__webpack_require__(44));

	var Modal = _interopRequire(__webpack_require__(45));

	var Nav = _interopRequire(__webpack_require__(46));

	var Navbar = _interopRequire(__webpack_require__(47));

	var NavItem = _interopRequire(__webpack_require__(48));

	var ModalTrigger = _interopRequire(__webpack_require__(49));

	var OverlayTrigger = _interopRequire(__webpack_require__(50));

	var OverlayMixin = _interopRequire(__webpack_require__(51));

	var PageHeader = _interopRequire(__webpack_require__(52));

	var Panel = _interopRequire(__webpack_require__(53));

	var PanelGroup = _interopRequire(__webpack_require__(54));

	var PageItem = _interopRequire(__webpack_require__(55));

	var Pager = _interopRequire(__webpack_require__(56));

	var Popover = _interopRequire(__webpack_require__(57));

	var ProgressBar = _interopRequire(__webpack_require__(58));

	var Row = _interopRequire(__webpack_require__(59));

	var SplitButton = _interopRequire(__webpack_require__(60));

	var SubNav = _interopRequire(__webpack_require__(61));

	var TabbedArea = _interopRequire(__webpack_require__(62));

	var Table = _interopRequire(__webpack_require__(63));

	var TabPane = _interopRequire(__webpack_require__(64));

	var Tooltip = _interopRequire(__webpack_require__(65));

	var Well = _interopRequire(__webpack_require__(66));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5);
	var ReactBootstrap = __webpack_require__(6);
	var PopupEdit = __webpack_require__(68);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5);
	var ReactBootstrap = __webpack_require__(6);
	var TagSearchAbstract = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classSet = _interopRequire(__webpack_require__(106));
			...
			return (
				React.createElement(Modal, React.__spread({},  this.props), 
			        React.createElement("div", {className: "modal-body"}, 
						...
						React.createElement(Input, {ref: "body", onChange: this.handleChangeBody, id: "idea-body", type: "textarea", rows: "10", value: this.props.body, placeholder: "Body"})
			        ), 
